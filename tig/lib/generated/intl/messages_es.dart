...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(date) => "La fecha cambiada es ${date}.";

  static String m3(error) => "Reinicie la aplicación.\nERROR: ${error}";

  static String m4(month) => "Tigs de ${month}";

  static String m5(price) => "${price} / mes";

  static String m6(item) => "${item} ha sido eliminado.";

  static String m7(minute, second) => "${minute} : ${second}";

  static String m8(endTime) => "Hora de finalización: ${endTime}";

  static String m9(startTime) => "Hora de inicio: ${startTime}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auth_google_login": MessageLookupByLibrary.simpleMessage(
    ...
    "auth_kakao_login": MessageLookupByLibrary.simpleMessage(
      "Iniciar sesión con Kakao",
    ),
    ...
    "home_save_completed": MessageLookupByLibrary.simpleMessage(
      "Guardado completado.",
    ),
    ...
    "menu_email_subject": MessageLookupByLibrary.simpleMessage(
      "Quisiera consultar.",
    ),
    "menu_logout_content": MessageLookupByLibrary.simpleMessage(
      "¿Quieres cerrar sesión?",
    ),
    "menu_logout_text": MessageLookupByLibrary.simpleMessage("Cerrar sesión"),
    ...
    "menu_update_intro": MessageLookupByLibrary.simpleMessage("Próximamente."),
    ...
    "menu_withdrawal_text": MessageLookupByLibrary.simpleMessage(

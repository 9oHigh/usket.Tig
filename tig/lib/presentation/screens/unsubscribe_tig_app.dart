...
class UnSubscribedTigApp extends StatefulWidget {
  const UnSubscribedTigApp({super.key});

  @override
  State<UnSubscribedTigApp> createState() => UnSubscribedTigAppState();
}

class UnSubscribedTigAppState extends State<UnSubscribedTigApp> {
  BannerAd? _bannerAd;
